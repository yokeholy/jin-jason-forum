...
?>
		...
		<form action="/functions/addpost_action.php" method="post">
			...
			<table cellpadding="0" cellspacing="0" class="AddPost">
				...
				<tr align="center">
					<td colspan="2" class="AddPost"><input name="Submit" type="submit" value="" style="background:url(/images/Post.png); width:100px; height:25px; border:0px; cursor:pointer; margin:2px;"><input type="reset" value="" style="background:url(/images/Clear.png); width:100px; height:25px; border:0px; cursor:pointer; margin:2px;"></td>
				</tr>
			</table>
		</form>
<?php
