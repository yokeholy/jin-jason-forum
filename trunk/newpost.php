...
<input name="tid" type="hidden" value="<?php echo $tid ?>" />
	...
	<table cellpadding="0" cellspacing="0" class="AddPostTable">
		...
		<tr align="center">
			<td colspan="2" class="AddPost"><input name="Submit" type="submit" value="Post the Reply!" /><input type="reset" value="No, clean them for me"></td>
		</tr>
	</table>
</form>
<?php
...
<input name="NewType" type="hidden" value="0" />
	<table cellpadding="0" cellspacing="0" class="AddPostTable">
		...
		<tr align="center">
			<td colspan="2" class="AddPost"><input name="Submit" type="submit" value="Post the New Thread!"><input type="reset" value="No, clean them for me"></td>
		</tr>
	</table>
</form>
<?php
