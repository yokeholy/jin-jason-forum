...
while($result = mysql_fetch_array($masterquery))
{
	...
	?>
		...
		<tr onmouseover="style.backgroundColor='#ddd'" onmouseout="style.backgroundColor='#fff'">
			<td class="MainForum"><p><?php if($replyCount[0] >= HOT) echo ('<img src="/images/hot.gif"/>');?><strong><a href="/viewthread.php?tid=<?php echo $result['PostID']?>"><span class="Sticky"><?php echo $result['Subject'];?></span></a></strong></p></td>
